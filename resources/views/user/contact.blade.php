...
<br><br>
    <section class="fully-wrapper-content "><!-- navbar & content left site &right side start-->
      <section class="wrapper-container">
        ...
        <br>
        <section class=""style="background-color:#5D6D7E; font-size: 20px;">
              <div class="ml-4 mr-4 text-light font-weight-bold lead" ><br>
                <div class="rounded" style="height: 70px; width: 100%;line-height:65px; text-align: center">
                    <strong class="h3">Contact Us</strong>
                </div>
                <br>

                <p class="h4 text-center">Having Queries? Feel free to contact us anytime!</p>
                <br><br>

                <div class="text-center">
                  <ul class="navbar-nav">
                    <li class="nav-item"><a class="btn btn-info" href="https://www.facebook.com/Gaming-Zone-105213311218222/" target="_blank"><i class="fab fa-facebook-square"></i>Facebook</a>facebook.com/Gaming-Zone</li><br>
                    <li class="nav-item"><a class="btn btn-danger" href="https://www.youtube.com/channel/UCy_JdFJWQrtukHJqj5v87dg" target="_blank"><i class="fab fa-youtube"></i>Youtube</a>youtube.com/channel/Gaming-Zone</li><br>
                    <li><a class="btn btn-success" href="#"><i class="fas fa-envelope"></i>E-mail</a> rasel.00x@gmail.com</li>
                  </ul>
