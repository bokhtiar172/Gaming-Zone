        ...
        <div class="col-md-8">
            <div class="card">
              <p class="text-center">
                ...
                <strong class="">GAMING ZONE REGISTER</strong>
                </p>

                <div class="card-body">
                    <form method="POST" action="{{ url('save_admin') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="text" name="name" value="" placeholder="Unique Name Here Type...">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" type="number" placeholder="Unique Number Here Type..." name="phone" value="">
                            </div>
                        </div>
